    ...
    <div className='top-0  mt-5 pb-4  left-0 w-full fixed z-99 rounded-full backdrop-blur-lg border border-white' style={{height:'15vh'}}  >
        ...
        <div className='mx-auto justify-between flex items-center px-4 py-4   md:px-20 lg:px-32'>
         ...
         <ul className='hidden md:flex gap-8 text-white '>
              ...
              <a href="/about" className='rounded-full px-6 py-2 bg-[#030946] text-white'>How to Use</a>
              <a href="/about" className='rounded-full px-6 py-2 bg-[#030946] text-white'>Services</a>
              <a href="/about" className='rounded-full px-6 py-2 bg-[#030946] text-white'>Contact</a>
