...
const Footer = () => {
  return (
    <div className='bg-black pt-4 px-4 md:px-20 lg:px-32 w-full overflow-hidden '>
        ...
        <div className=' container flex flex-col md:flex-row gap-16 items-center justify-between mx-auto  pt-10 '>
                ...
                <div className='flex-1 bg-blue-200  pl-4 '>
                        <h3 className='text-white text0xl font-semibold'>Contact</h3>
                         <div >
                                <div className='flex'>
