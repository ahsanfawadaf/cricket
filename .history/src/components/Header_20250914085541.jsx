  ...
  return (
    ...
    <Navbar/>
         <div className='flex flex-col mx-auto items-start px-4 md:px-20 lg:px-32'>
             <h1 className='text-2xl font-semibold sm:text-6xl text-white gap-4 max-w-4xl inline-block pt-20'>Take your game to <br /> the next level with <span className='text-4xl sm:text-6xl font-bold'>CrinInsight</span>.</h1>
