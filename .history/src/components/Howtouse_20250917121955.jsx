...
const Howtouse = () => {
  ...
  return (
    <div className='bg-gray-200 py-10'>
      ...
      <div className='max-w-6xl mx-auto px-4 gird grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-8'>

        { cards.map((ca) =>(
          <div key={ca.id} className='bg-white shadow-lg rounded-lg p-4 mb-4'>
           
           <h3 className='text-xl font-semibold text-gray-900 '>{`0${ca.id}`}</h3>
