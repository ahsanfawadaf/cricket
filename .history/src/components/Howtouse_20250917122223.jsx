  ...
  return (
    <div className='bg-gray-200 py-10'>
      ...
      <div className='max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-8'>
        ...
        { cards.map((ca) =>(
          <div key={ca.id} className='bg-white shadow-lg rounded-lg py-4 px-2 mb-4'>
           
           <h3 className='text-xl font-semibold text-gray-900 mb-4 '>{`0${ca.id}`}</h3>

           <h4 className='text-lg font-bold text-gray-900 '>{ca.title}</h4>
           <p>{ca.description}</p>
