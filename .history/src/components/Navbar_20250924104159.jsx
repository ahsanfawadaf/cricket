...
useEffect(( )=>{
  ...
  return (
   -4 <div className='top-0  mt-5 pb-4  left-0 w-full fixed z-99 rounded-full backdrop-blur-lg border overflow-hidden border-white md:h-[15vh]'  >
        

        <div className='mx-auto justify-between flex container items-center px-6 py   md:px-20 lg:px-32'>
