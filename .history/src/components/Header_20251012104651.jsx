...
const Header = () => {
  return (
    ...
    <Navbar   />
         ...
         <div className='flex flex-col mx-auto items-center justify-center mt-4  lg:items-start px-20 pt lg:px-32'>
             <motion.h1
             ...
             className='flex  lg:flex-row gap-4 mt-6'>
              <Link to="/login">  <button className='cursor-pointer hover:bg-blue-200 rounded-full bg-[#030946] text-white px-2 py-2'>Get Started</button> </Link
