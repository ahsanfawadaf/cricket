  ...
  return (
    ...
    <Navbar/>
         <div className='flex flex-col mx-auto items-start px-2 md:px-20 lg:px-32'>
             <h1 className='text-md block font-semibold sm:text-6xl text-white gap-2 max-w-6xl inline-block pt-20'>Take your game to  the next level with <span className='text-4xl sm:text-6xl font-bold'>CrinInsight</span>.</h1>
