...
const Navbar = () => {
  return (
    <div className='top-0 left-0 w-full fixed z-10' style={{height:'5vh'}}  >
        ...
        <div className='mx-auto justify-between flex items-center px-6 py-4 mb-20 bg-transparent md:px-20 lg:px-32'>


         <img src={cric_logo} alt="Cricekt team logo" className="h-full" style={{maxHeight:'100%'}} />
