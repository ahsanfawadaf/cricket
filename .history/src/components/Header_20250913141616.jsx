  ...
  return (
    ...
    <Navbar/>
         <div className='flex flex-col mx-auto items-start px-4 md:px-20 lg:px-32'>
             <h1 className='text-4xl text-sem sm:text-6xl text-white gap-6 max-w-3xl inline-block pt-10'>Take your game to the next level with <span className='text-5xl sm:text-6xl font-bold'>CrinInsight</span>.</h1>
             <div>
