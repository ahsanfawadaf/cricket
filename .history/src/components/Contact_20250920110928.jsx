        ...
        <div className='mt-6 mx-8'>
          ...
          <form >
                ...
                <div>
                      ...
                      <textarea name="Message" className=' w-full pl-2 border border-gray-400 bg-white rounded px-4 py-3 h-48 mt-2' placeholder='Message'></textarea>
          ...
          <button className='rounded-md bg-[#030946]'>SEND</button>
        </div>
