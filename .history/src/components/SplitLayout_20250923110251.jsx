    ...
    className='w-full h-75vh flex flex-col md:flex-row'>
        ...
        <div className='w-[65%] h-full bg-black flex flex-col items-start p-20 justify-center'>
           ...
           <div className=' flex gap-4'>
             ...
             <button className='cursor-pointer hover:bg-blue-500 border rounded-full bg-white py-2 px-6'>TRY NOW</button>
            <button className='cursor-pointer hover:bg-blue-500 border rounded-full text-white border-white bg-black px-4 py-2'>CONTACT US</button>
           </div>
        </div>
