...
const Navbar = () => {
  return (
    <div className='top-0 mt-4  left-0 w-full fixed z-10 rounded-full bg-black' style={{height:'15vh'}}  >
        

        <div className='mx-auto justify-between flex items-center px-4 py-4  bg-transparent md:px-20 lg:px-32'>
