...
const SplitLayout = () => {
  return (
    <div className='bg-gray-200 flex py-10 w-full h-screen'>
    
    <div className='w-[65%] mx-auto text-white bg-black  top-0 left-0  items-center justify-center  p-8'>
         <h2>Why CricInsight?</h2>
    ...
    <div className='w-[35%] bg-gray-900 justify-center items-center '>
