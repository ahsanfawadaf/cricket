...
const Splitlayout = () => {
  return (
    ...
    className='w-full h-75vh flex flex-col lg:flex-row'>

        <div className='w-[65%] h-full bg-black flex flex-col w-full items-start p-20 justify-center'>
           ...
           <Link to="/login"><button className='cursor-pointer hover:bg-blue-800 border rounded-full bg-white py-2 px-6'>TRY NOW</button> </Link>
            <button className='cursor-pointer hover:bg-blue-800 border rounded-full text-white border-white bg-black px-4 py-2'>CONTACT US</button>
           </div>
        </div>

        <div className='w-[35%] h-full w-full flex bg-gray-300'>
