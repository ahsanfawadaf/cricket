        ...
        <div className='mt-6 mx-8'>
          ...
          <form >
                ...
                <div className='flex flex-wrap gap-2'>
                     ...
                     <div className='w-full md:w-1/4 py-4 text-left'>
                     <input type="text" name='Name' placeholder='Full Name' className='w-full rounded border bg-white ' />
                     </div>

                     <div className='w-full md:w-1/4 text-left'>
                     <input type="text" name='Name' placeholder='Company Name' className='w-full rounded border bg-white ' />
                     </div>
                ...
                <div>
                      <div>
                        <input type="Email" name='Email' placeholder='Email' className='w-full rounded border bg-white' />
                      </div>
