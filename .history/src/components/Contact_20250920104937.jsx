        ...
        <div className='mt-6 mx-8'>
          ...
          <form >
                ...
                <div className='flex flex-wrap gap-2'>
                     ...
                     <input type="text" name='Name' placeholder='Full Name' className='w-1/2 rounded border bg-white py-4 px-16 ' />
                     </div>

                     <div className='w-full md:w-1/4 text-left'>
                     <input type="text" name='Name' placeholder='Company Name' className='w-1/2 rounded border bg-white py-4 ' />
                     </div>
