  ...
  return (
    <div className='top-0 left-0 w-full absolute z-10' style={{height:'5vh'}} >
        ...
        <div className='mx-auto justify-between flex container items-center px-6 py-4 bg-transparent md:px-20 lg:px-32'>
         ...
         <button className='rounded-full px-6 py-2 bg-white'>Login</button>
        </div>
