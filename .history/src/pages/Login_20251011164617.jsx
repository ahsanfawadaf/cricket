  ...
  return (
    <div className="flex min-h-screen bg-white">
      ...
      <div className="bg-white py-4 flex flex-col items-start w-1/2 justify-start my-12 px-30 rounded-lg">
        ...
        <button className="bg-[#030947] w-full rounded-full  text-white px-4 py-2 rounded mb-2">
          Login 
        </button>
        <div className='flex items-center justify-center '>
            <span className='border-b border-gray-500 w-full mr-2'></span>
          <p className='bg-gray-500'>or</p>
           <span className='border-b border-gray-500 w-full ml-2'></span>
        </div>
      </div>
    </div>
  );
