    ...
    <div className="flex min-h-screen bg-white">
      ...
      <div className="bg-white py-4 flex flex-col items-start w-1/2 justify-start my-12 px-30 rounded-lg">
        ...
        <div className='text-left mb-4'>
          <input type="email" placeholder="Email Address *" className="border border-gray-200 py-2 px-24  " />
        </div>
        <div className='text-left mb-4'>
          <input type="password" placeholder="Password *" className="border border-gray-200 py-2  px-24  " />
        </div>
        ...
        <div className="flex flex-row w-full gap-12 my-4">
          <button className="bg-transparent border border-gray-200 text-black p-2  rounded mb-2">
            Sign in with Google
          </button>
          <button className="bg-transparent text-black border border-gray-200 p-2 rounded mb-2">
