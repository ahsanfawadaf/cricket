...
const Login = () => {
  return (
    <div className="flex min-h-screen bg-white">
      ...
      <div className="bg-white p-8 flex flex-col items-start w-1/2 justify-center rounded-lg shadow-lg">
        <h2 className="text-4xl font-bold mb-4">Login</h2>
        <input type="email" placeholder="Email" className="border p-2 mb-4 " />
