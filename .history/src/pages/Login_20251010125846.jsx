  ...
  return (
    <div className="flex min-h-screen bg-white">
      ...
      <div className="bg-white py-4 flex flex-col items-start w-1/2 justify-start my-12 px-30 rounded-lg">
        ...
        <div><input type="email" placeholder="Email Address *" className="border py-2 text-left px-24 mb-4 " /></div>
        <div><input type="password" placeholder="Password *" className="border py-2 text-left px-24 mb-4 " /></div>
