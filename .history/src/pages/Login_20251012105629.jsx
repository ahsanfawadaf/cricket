    ...
    <div className="flex min-h-screen bg-white">
      ...
      <div className="bg-white py-4 flex flex-col items-start w-1/2 justify-start my-12 px-30 rounded-lg">
        ...
        <div className="flex flex-row w-full my-4">
          <button className="bg-transparent border border-gray text-black px-4 pr-2 rounded mb-2">
            Sign in with Google
          </button>
          <button className="bg-transparent text-black border border-gray px-4 pl-2 rounded">
