    ...
    <div className="flex min-h-screen bg-white">
      ...
      <div className="bg-white py-4 flex flex-col items-start w-1/2 justify-start my-12 px-30 rounded-lg">
        ...
        <div className='text-left mb-4'>
          <input type="email" placeholder="Email Address *" className="border border-gray-300 rounded py-2 px-26  " />
        </div>
        <div className='text-left mb-4'>
          <input type="password" placeholder="Password *" className="border border-gray-300 rounded py-2  px-26  " />
        </div>
